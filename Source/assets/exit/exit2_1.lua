...
print("Loading assets.exit.exit2_1...");
...
function scene:createScene( event )
  ...
  exit = display.newImage("images/exit/stage3complete.png", true);
...
function scene:willEnterScene( event )
 resetCamera();
  if(kiosk.labels["exiting_completion_s3"] == nil) then    
    pushKioskFrame(function()
      storyboard.gotoScene( "assets.map_screen", "crossFade", 250 );
    end, 1000, 1000, "exiting_completion_s3");
...
function scene:didExitScene( event )
        ...
        -----------------------------------------------------------------------------
  storyboard.purgeScene( "assets.exit.exit2_1" );
...
function scene:destroyScene( event )
  ...
  display.remove(exit);
  print( "((destroying exit2_1 scene's view))" );        
end
...
print("Loaded assets.exit.exit2_1!\n");
