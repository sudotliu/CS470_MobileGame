...
-- File name: history2_1.lua
-- Purpose: show historical info slide for level 2, stage 1
-- Group 5:
--    Terry Liu
--    Raymond Ononiwu
--    William Thomas
-- Description: 
--    This will show before level 2, stage 1. Click to continue
-----------------------------------------------------------------------------------------

-- This sets up the history screen of the game -------------------------------------
print("Loading assets.history.history2_1...");
...
local function onSceneTouch( self, event )
 ...
 audio.stop(1);
 audio.rewind(music.stage3);
 audio.play(music.stage3, {channel=1,loops=-1});
...
function scene:createScene( event )
  ...
  history = display.newImage("images/history/2_1.png", true);
...
resetCamera();
  if(kiosk.labels["entering_history_3"] == nil) then
    pushKioskFrame(function() end, 0, 0, "entering_history_3");
...
function scene:didExitScene( event )
  ...
  history=nil;
  storyboard.purgeScene( "assets.history.history2_1" );
...
function scene:destroyScene( event )
  ...
  print( "((destroying history_2_1 scene's view))" );        
end
