...
-- File name: history2_2.lua
-- Purpose: show historical info slide for level 2, stage 4
-- Group 5:
--    Terry Liu
--    Raymond Ononiwu
--    William Thomas
-- Description: 
--    This will show before level 2, stage 4. Click to continue
-----------------------------------------------------------------------------------------

-- This sets up the history screen of the game -------------------------------------
print("Loading assets.history.history2_2...");
...
local function onSceneTouch( self, event )
 ...
 audio.stop(1);
 audio.rewind(music.stage4);
 audio.play(music.stage4, {channel=1,loops=-1});
...
function scene:createScene( event )
  ...
  history = display.newImage("images/history/2_2.png", true);
...
resetCamera();
  if(kiosk.labels["entering_history_4"] == nil) then
    pushKioskFrame(function() end, 0, 0, "entering_history_4");
...
function scene:didExitScene( event )
        ...
        -----------------------------------------------------------------------------
  storyboard.purgeScene( "assets.history.history2_2" );
...
function scene:destroyScene( event )
  ...
  history=nil;
  print( "((destroying history_2_2 scene's view))" );        
end
